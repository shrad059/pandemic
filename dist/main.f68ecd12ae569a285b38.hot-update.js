...
function initGlobe() {
  Globe = new three_globe__WEBPACK_IMPORTED_MODULE_0__.default({
    ...
    .hexPolygonColor((e) => {
      return "white"; // Keep country colors white
    });
